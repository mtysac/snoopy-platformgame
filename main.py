...
class Game:
    def __init__(self, num_players: int = 1) -> None:
        ...
        self.movement2: list[bool] = [False, False]
...
def play(num_players: int = 1) -> None:
    Game(num_players).run()


def player_select() -> None:
    while True:
...
def options() -> None:
    while True:
        ...
        SCREEN.blit(OPTIONS_TEXT, OPTIONS_TEXT.get_rect(center=(640, 220)))

        OPTIONS_TEXT2 = get_font(35).render("P2: UP jump  LEFT  RIGHT", True, "#ffaaaa")
        SCREEN.blit(OPTIONS_TEXT2, OPTIONS_TEXT2.get_rect(center=(640, 300)))
...
def main() -> None:
    ...
    while True:
        ...
        SCREEN.blit(MENU_TEXT, MENU_TEXT.get_rect(center=(640, 170)))
